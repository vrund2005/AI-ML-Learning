...
doll_red = cv2.imread("/Users/vrund/Desktop/Projects/CV_Squid_Game/Photos/doll_red.png", cv2.IMREAD_UNCHANGED)
doll_green = cv2.imread("/Users/vrund/Desktop/Projects/CV_Squid_Game/Photos/doll_green.png", cv2.IMREAD_UNCHANGED)
...
prev_positions = None
movement_threshold = 0.01  # tweak if needed
